...
ffmpeg -loglevel info -ar 44100 -ac 2 -f s16le -i /dev/zero \
        -f video4linux2 -s 640x640 -r 10 -i /dev/${VIDEO_DEVICE} \
        -vf "drawtext=fontfile=/usr/share/fonts/dejavu/DejaVuSans-Bold.ttf:text='%{localtime\:%T}': fontcolor=white@0.6: fontsize=12: x=0: y=0" \
